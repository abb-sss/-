  ...
  return (
    <div className="p-8 max-w-6xl mx-auto w-full">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <button
          onClick={handleCreateNew}
          className="group h-48 border-2 border-dashed border-gray-200 hover:border-blue-400 hover:bg-blue-50/30 rounded-xl flex flex-col items-center justify-center text-gray-500 hover:text-blue-600 transition-colors cursor-pointer w-full"
        >
